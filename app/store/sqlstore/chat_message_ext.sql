...
CREATE TABLE bw_chat_message_ext (
...
CREATE UNIQUE INDEX idx_bw_chat_message_ext_space_session_message ON bw_chat_message_ext (space_id, session_id, message_id); -- 空间ID索引，提升按空间查询的速度
