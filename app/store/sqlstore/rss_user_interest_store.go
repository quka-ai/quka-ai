...
// Get 根据ID获取用户兴趣记录
func (s *RSSUserInterestStore) Get(ctx context.Context, id int64) (*types.RSSUserInterest, error) {
...
// UpdateWeight 更新兴趣权重
func (s *RSSUserInterestStore) UpdateWeight(ctx context.Context, id int64, weight float64) error {
...
// Delete 删除用户兴趣记录
func (s *RSSUserInterestStore) Delete(ctx context.Context, id int64) error {
